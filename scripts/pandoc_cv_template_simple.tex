...
$elseif(useTgPagella)$
% Palatino-style font from TeX Gyre, with real bold/italic variants.
\usepackage{fontspec}
\defaultfontfeatures{Ligatures=TeX}
\setmainfont{TeXGyrePagella}[
    Path={/usr/local/texlive/2024basic/texmf-dist/fonts/opentype/public/tex-gyre/},
...
\newif\iffirstcvsubsection
\firstcvsubsectiontrue
...
\begin{center}
    {\fontsize{20}{24}\selectfont\bfseries Ziru Wei}\\[5pt]
        {\large
          \href{mailto:ziru.wei@colorado.edu}{ziru.wei@colorado.edu} \,|\, 
          \href{https://ziru-wei.github.io}{ziru-wei.github.io}
        }\\[8pt]
\end{center}
\vspace{0.25em}
